...
- Every CSV generated by the dataset builder has a paired `name_filtered.csv`
...
- Every CSV generated by the dataset builder has a sibling `.log` file. An
  empty log means no warnings or errors were recorded for that dataset. CSVs
